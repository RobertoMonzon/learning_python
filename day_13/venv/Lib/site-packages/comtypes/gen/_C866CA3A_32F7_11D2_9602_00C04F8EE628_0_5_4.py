...
__all__ = [
    'DISPID_SOTsItem', 'SPRECORESULTTIMES', 'eLEXTYPE_LETTERTOSOUND',
    'SRSActiveAlways', 'SpeechVisemeFeature', 'tagSTATSTG',
    'SGDSActive', 'SSTTTextBuffer', 'DISPID_SOTRemoveStorageFileName',
    'SPRS_ACTIVE_USER_DELIMITED', 'SDTReplacement',
    'DISPID_SpeechAudioStatus', 'DISPID_SOTDataKey',
    'DISPID_SpeechAudioFormat', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SGRAddState', 'SPGRAMMARSTATE', 'SINoise',
    'DISPID_SOTCSetId', 'DISPID_SRSCurrentStreamPosition',
    'SpeechGrammarRuleStateTransitionType', 'SPPHRASEPROPERTY',
    'DISPID_SRGId', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpeechVoice',
    'ISpResourceManager', 'ISpPhoneticAlphabetSelection',
    'SPEI_PHRASE_START', 'eLEXTYPE_PRIVATE15', 'SpWaveFormatEx',
    'DISPID_SpeechBaseStream', 'SAFT12kHz8BitMono',
    'DISPID_SDKDeleteKey', 'SITooSlow', 'SAFTADPCM_22kHzMono',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVEStreamStart',
    'SPINTERFERENCE_TOOLOUD', 'eLEXTYPE_PRIVATE5',
    'SPDKL_CurrentConfig', 'DISPID_SpeechCustomStream',
    'SPEI_RESERVED1', 'DISPID_SPARecoResult',
    'DISPID_SPRules_NewEnum', 'DISPID_SRProfile', 'SGRSTTWord',
    'SpeechCategoryPhoneConverters', 'SpeechTokenShellFolder',
    'SLTUser', 'DISPID_SVResume', 'DISPID_SVSVisemeId', 'SPSVerb',
    'DISPID_SPPFirstElement',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eLEXTYPE_USER',
    'SPLO_STATIC', 'SAFT16kHz16BitStereo',
    'DISPID_SVSInputWordLength', 'Speech_Max_Pron_Length',
    'DISPID_SPRuleParent', 'DISPID_SPCLangId', 'SRTAutopause',
    'SRERecognition', 'ISpeechPhraseInfo', 'SGSEnabled', 'SVP_5',
    'DISPID_SPRFirstElement', 'DISPID_SABIEventBias',
    'DISPID_SpeechPhraseRules', 'DISPID_SRRTimes',
    'DISPID_SAEventHandle', 'SP_VISEME_6', 'SPEI_SR_AUDIO_LEVEL',
    'SPAUDIOSTATUS', 'eLEXTYPE_RESERVED9',
    'SAFTCCITT_uLaw_44kHzStereo', 'SP_VISEME_9', 'SPAO_RETAIN_AUDIO',
    'SpStream', 'DISPID_SABIBufferSize', 'SPEI_MIN_SR', 'SpVoice',
    'DISPID_SPRuleNumberOfElements', 'SVP_8',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SASetState', 'DISPID_SRCreateRecoContext',
    'ISpeechRecognizerStatus', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SVIsUISupported', 'DISPID_SRRSaveToMemory',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVSyncronousSpeakTimeout',
    'SGSExclusive', 'DISPID_SPIAudioSizeTime', 'DISPID_SCSBaseStream',
    'SPEI_SENTENCE_BOUNDARY', 'SPINTERFERENCE_TOOQUIET',
    'ISpeechPhraseRules', 'SPRST_NUM_STATES',
    'DISPID_SASCurrentDevicePosition', 'SpNullPhoneConverter',
    'SVSFlagsAsync', 'ISpeechResourceLoader', 'eLEXTYPE_RESERVED6',
    'SVP_6', 'SpeechDisplayAttributes', 'DISPID_SGRsCommit',
    'DISPID_SpeechRecognizerStatus', 'SVP_3', 'SSTTWildcard',
    'ISpeechObjectTokens', 'DISPID_SpeechPhraseInfo', 'SVF_None',
    'DISPID_SWFEAvgBytesPerSec', 'SVSFIsXML',
    'DISPID_SAFGetWaveFormatEx', 'SP_VISEME_17', 'SRTReSent',
    'DISPID_SPRs_NewEnum', 'DISPID_SDKEnumKeys', 'SPWF_INPUT',
    'SGRSTTDictation', 'SVSFParseSapi', 'SPEI_INTERFERENCE',
    'DISPID_SRGDictationUnload', 'DISPID_SPRulesCount',
    'SPDATAKEYLOCATION', 'SPPS_Modifier', 'ISpeechGrammarRules',
    'SpeechRunState', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SRCEInterference', 'SpeechAudioVolume',
    'SECNormalConfidence', 'SpPhoneConverter', 'DISPID_SGRSTsCount',
    'SP_VISEME_3', 'SpeechEmulationCompareFlags', 'DISPID_SDKOpenKey',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SAFTCCITT_ALaw_44kHzMono', 'SP_VISEME_19', 'SPSNoun',
    'SAFT24kHz16BitMono', 'ISpeechPhoneConverter',
    'DISPID_SPEDisplayText', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPPName', 'ISpeechVoiceStatus', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRCEPropertyNumberChange', 'SAFT11kHz16BitStereo',
    'DISPID_SASState', 'SREStateChange', 'SVESentenceBoundary',
    'SpeechGrammarTagWildcard', 'SVP_1', 'SRSInactive',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SVSLastBookmark',
    'DISPID_SLWPronunciations', 'SpeechVoiceCategoryTTSRate',
    'SVP_20', 'SPWORDLIST', 'SpCompressedLexicon',
    'ISpeechPhraseElements', 'SPPHRASERULE',
    'DISPID_SPPEngineConfidence', 'ISpeechMMSysAudio',
    'DISPID_SLPType', 'DISPID_SRGIsPronounceable', 'DISPID_SBSRead',
    'SPSHT_Unknown', 'SDTPronunciation', 'SDKLDefaultLocation',
    'DISPID_SRGDictationLoad', 'SPEI_END_INPUT_STREAM',
    'SpeechCategoryRecognizers', 'SPEI_MAX_SR',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SOTSetId', 'SPCT_SUB_DICTATION',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'eLEXTYPE_VENDORLEXICON',
    'SPEI_SOUND_START', 'DISPID_SRCPause', 'DISPID_SpeechGrammarRule',
    'STCLocalServer', 'DISPID_SVSInputSentencePosition',
    'SPEI_TTS_BOOKMARK', 'DISPID_SRCRequestedUIType',
    'SpeechAudioState', 'DISPID_SRRTOffsetFromStart',
    'SREPhraseStart', 'SpeechEngineConfidence',
    'SpeechCategoryVoices', 'SAFTGSM610_22kHzMono',
    'SAFT8kHz16BitStereo', 'SAFT12kHz8BitStereo', 'SREAllEvents',
    'DISPID_SpeechGrammarRuleState', 'SAFTADPCM_8kHzStereo',
    'SRATopLevel', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPIProperties',
    'ISpeechPhraseAlternate', 'DISPID_SpeechPhraseProperty',
    'SPWT_LEXICAL', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SPIAudioSizeBytes', 'ISpeechLexiconWords',
    'SpeechStreamFileMode', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPGRAMMARWORDTYPE', 'DISPID_SWFEBlockAlign',
    'SAFT22kHz8BitStereo', 'DISPID_SPEsItem',
    'SpeechGrammarTagUnlimitedDictation', 'SVEStartInputStream',
    'SpUnCompressedLexicon', 'DISPID_SVEEnginePrivate',
    'DISPID_SVVolume', 'SDTAudio', 'SPWORDPRONUNCIATIONLIST',
    'SRARoot', 'DISPID_SBSSeek', 'DISPID_SPAsItem',
    'SPSEMANTICFORMAT', 'DISPID_SGRName', 'SPEI_MIN_TTS',
    'ISpeechTextSelectionInformation', 'SDTProperty',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SSSPTRelativeToStart',
    'SPEI_START_INPUT_STREAM', 'SPSMF_UPS', 'DISPID_SGRClear',
    'SPAO_NONE', 'SRADefaultToActive', 'ISpeechLexiconPronunciation',
    'ISpeechLexicon', 'IInternetSecurityMgrSite', 'SPFM_NUM_MODES',
    'SAFTCCITT_ALaw_11kHzMono', 'SpeechInterference',
    'DISPID_SPIReplacements', 'DISPID_SPRNumberOfElements',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRRRecoContext',
    'DISPID_SPPNumberOfElements', 'DISPID_SRCSetAdaptationData',
    'SpeechCategoryAppLexicons', 'SINone', 'SVPNormal',
    'DISPID_SPIGrammarId', 'SECFEmulateResult',
    'DISPID_SRGSetTextSelection', 'SPAUDIOOPTIONS',
    'SREPropertyNumChange', 'SPSSuppressWord', 'SAFT16kHz8BitStereo',
    'DISPID_SVEViseme', 'SpeechCategoryAudioIn',
    'DISPID_SPPs_NewEnum', 'SpeechVoiceEvents', '_SPAUDIOSTATE',
    'SVP_10', 'DISPID_SASFreeBufferSpace', 'SASPause',
    'SDKLCurrentConfig', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPPS_RESERVED3', 'SAFT22kHz16BitMono', 'IStream',
    'DISPID_SRCEPhraseStart', 'DISPIDSPTSI',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpeechAudioBufferInfo',
    'SPSModifier', 'DISPID_SVSpeakStream', 'DISPID_SGRSTWeight',
    'SRSInactiveWithPurge', 'ISpAudio', 'DISPID_SRGRecoContext',
    'SDTAll', 'eLEXTYPE_PRIVATE2', 'SPPS_Function',
    'DISPID_SGRSTsItem', 'DISPID_SRCCreateResultFromMemory',
    'SpeechUserTraining', 'SVP_13', 'SAFTADPCM_44kHzStereo',
    'DISPID_SpeechRecognizer', 'SpCustomStream', 'DISPID_SOTCId',
    'SRTExtendableParse', 'SAFTNoAssignedFormat', 'DISPID_SRState',
    'SVF_Emphasis', 'DISPID_SPIElements', 'SpeechDataKeyLocation',
    'ISpeechPhraseReplacement', 'SRAExport', 'SAFTGSM610_8kHzMono',
    'SRTEmulated', 'SpPhraseInfoBuilder',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRCResume',
    'SVSFVoiceMask', 'SpeechEngineProperties', 'SAFT8kHz16BitMono',
    'ISpObjectWithToken', 'SpAudioFormat', 'SPGS_DISABLED',
    'DISPID_SPIEngineId', 'DISPID_SGRsFindRule',
    'SpeechVoicePriority', 'eWORDTYPE_ADDED', 'SREInterference',
    'DISPID_SVSpeak', 'SPLEXICONTYPE', 'SPRST_ACTIVE',
    'SAFTCCITT_uLaw_11kHzMono', 'SDKLLocalMachine',
    'DISPID_SLGenerationId', 'eLEXTYPE_MORPHOLOGY', 'SP_VISEME_10',
    'SpeechGrammarState', 'ISpShortcut', 'SpeechBookmarkOptions',
    'SGDSInactive', 'DISPID_SGRSTPropertyValue', 'SPCS_ENABLED',
    'DISPID_SMSGetData', 'SPSHT_EMAIL', 'SSFMOpenReadWrite',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechRecoContext', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SGRSTransitions', 'ISpRecoGrammar2', 'SVSFIsNotXML',
    'ISpEventSource', 'DISPID_SRIsShared', 'SPEI_END_SR_STREAM',
    'SpeechPartOfSpeech', 'SpObjectTokenCategory', 'SPEI_PHONEME',
    'DISPID_SRSAudioStatus', 'DISPID_SVVoice', 'ISpeechRecoContext',
    'SpeechRegistryLocalMachineRoot', 'SECFDefault', 'DISPID_SLWWord',
    'DISPID_SGRInitialState', 'ISpeechFileStream',
    'DISPID_SpeechPhraseProperties',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRGetPropertyString',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPCT_DICTATION',
    'DISPID_SABufferInfo', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRCEEndStream', 'SPGS_EXCLUSIVE',
    'DISPID_SPAStartElementInResult', 'SpNotifyTranslator',
    'DISPID_SBSFormat', 'ISpRecognizer',
    'DISPID_SpeechAudioBufferInfo', 'SpeechDictationTopicSpelling',
    'eLEXTYPE_PRIVATE16', 'ISpeechPhraseInfoBuilder',
    'SPEI_START_SR_STREAM', 'DISPID_SRSetPropertyString',
    'ISpEventSink', 'DISPID_SpeechLexiconProns', 'SRESoundStart',
    'SPXRO_SML', 'SPPS_SuppressWord', 'SAFT44kHz8BitStereo',
    'DISPID_SRDisplayUI', 'DISPID_SPPsCount',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechObjectTokenCategory', 'SpFileStream',
    'DISPID_SABufferNotifySize', 'SPPS_Noncontent',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPCT_SUB_COMMAND', 'SPBO_NONE',
    'DISPID_SMSADeviceId', 'DISPID_SMSSetData', 'DISPID_SAFType',
    'ISpNotifyTranslator', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPAR_High', 'eLEXTYPE_PRIVATE3', 'DISPID_SWFEChannels',
    'ISpObjectToken', 'SLODynamic', 'DISPID_SPPChildren',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SDA_Two_Trailing_Spaces',
    'SPRECOGNIZERSTATUS', 'SVEVoiceChange', 'DISPID_SOTId',
    'ISpDataKey', 'DISPID_SGRAddResource',
    'DISPID_SpeechPhraseReplacement', 'SpeechDiscardType',
    'SpeechPropertyResourceUsage', 'DISPID_SRCVoicePurgeEvent',
    'SVSFParseAutodetect', 'DISPID_SGRSTPropertyId',
    'SAFT24kHz8BitStereo', 'SASRun', 'SPAS_STOP',
    'SpeechSpecialTransitionType', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechPropertyAdaptationOn', 'DISPID_SLGetGenerationChange',
    'SAFT22kHz8BitMono', 'DISPID_SRCEHypothesis', 'SpMMAudioOut',
    'SVPAlert', 'DISPID_SLPsItem', 'ISpXMLRecoResult', 'SVEViseme',
    'SpeechRuleAttributes', 'SpeechAudioFormatGUIDText',
    'DISPID_SPIStartTime', 'DISPID_SPRuleFirstElement',
    'DISPID_SRCERecognition', 'SPAUDIOBUFFERINFO', 'DISPID_SBSWrite',
    'SREStreamStart', 'DISPID_SOTCGetDataKey', 'SRTStandard',
    'eLEXTYPE_PRIVATE1', 'DISPIDSPTSI_SelectionLength',
    'SPEI_REQUEST_UI', 'SpMMAudioEnum', 'SpPhoneticAlphabetConverter',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SLPPartOfSpeech', 'SpeechWordType', 'SPCS_DISABLED',
    'SVP_15', 'SAFTCCITT_uLaw_22kHzMono', 'SAFT8kHz8BitStereo',
    'DISPID_SpeechPhraseAlternates', 'SPSMF_SAPI_PROPERTIES',
    'SPSEMANTICERRORINFO', 'SP_VISEME_12',
    'DISPIDSPTSI_SelectionOffset', 'SAFT44kHz8BitMono',
    'SAFT11kHz16BitMono', 'ISpSerializeState', 'SECFIgnoreKanaType',
    'DISPID_SRGCmdLoadFromResource', 'SpeechVoiceSkipTypeSentence',
    'ISpNotifySink', 'SPPHRASEREPLACEMENT',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRCEAudioLevel',
    'DISPIDSPTSI_ActiveOffset', 'SVP_14', 'DISPID_SPAs_NewEnum',
    'SFTInput', 'SFTSREngine', 'SVP_17', 'SREAudioLevel',
    'SpeechGrammarWordType', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SVGetVoices', 'DISPID_SVDisplayUI',
    'DISPID_SLRemovePronunciation', 'DISPID_SDKGetlongValue',
    'SAFT32kHz16BitMono', 'DISPID_SVWaitUntilDone', 'SVF_Stressed',
    'DISPIDSPRG', 'SVSFPersistXML', 'ISpeechBaseStream', 'SVEPhoneme',
    'SWPKnownWordPronounceable', 'SSSPTRelativeToEnd', 'SVP_19',
    'SSFMOpenForRead', 'DISPID_SPPsItem', 'SDKLCurrentUser',
    'SGRSTTTextBuffer', 'DISPID_SRSSupportedLanguages', 'SPBO_AHEAD',
    'SAFTADPCM_8kHzMono', 'SGSDisabled', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPEEngineConfidence', 'ISpeechPhraseProperty',
    'DISPID_SVSLastBookmarkId', 'SPSHT_NotOverriden',
    'SPPS_Interjection', 'SpObjectToken',
    'DISPID_SOTCEnumerateTokens', 'ISpeechObjectTokenCategory',
    'SpInProcRecoContext', 'SpeechTokenValueCLSID',
    'eLEXTYPE_PRIVATE4', 'DISPID_SpeechWaveFormatEx',
    'ISequentialStream', 'DISPID_SpeechMemoryStream',
    'DISPID_SPRuleName', 'SpMMAudioIn', 'SPRULE', 'DISPID_SGRSTType',
    'DISPID_SVStatus', 'ISpeechDataKey', 'DISPID_SVSPhonemeId',
    'eLEXTYPE_PRIVATE18', 'DISPID_SVEStreamEnd',
    'DISPID_SRCERecognizerStateChange', 'ISpeechRecoResultTimes',
    '_ISpeechRecoContextEvents', 'SGLexicalNoSpecialChars',
    'SpeechTokenKeyFiles', 'ISpeechObjectToken', 'SVSFParseSsml',
    'SPRST_ACTIVE_ALWAYS', 'ISpRecognizer2', 'SP_VISEME_16',
    'DISPID_SLPs_NewEnum', 'SP_VISEME_20',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SREHypothesis',
    'SPSHORTCUTPAIR', 'DISPID_SVGetProfiles', 'DISPID_SRCBookmark',
    'SWTDeleted', 'SVP_9', 'DISPID_SRRTTickCount',
    'SPSERIALIZEDRESULT', 'DISPID_SpeechLexiconWord', 'SPEI_MAX_TTS',
    'SPRS_INACTIVE', 'SLTApp', 'SPWT_PRONUNCIATION', 'ISpProperties',
    'tagSPTEXTSELECTIONINFO', 'SECHighConfidence',
    'SAFT32kHz8BitStereo', 'ISpeechRecoGrammar',
    'IInternetSecurityManager', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SOTGetAttribute',
    'ISpStream', 'SWPUnknownWordPronounceable', 'DISPID_SVPriority',
    'SP_VISEME_7', 'SPEI_RECOGNITION', 'STCAll',
    'DISPID_SPERequiredConfidence', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SVGetAudioInputs', 'SPPS_RESERVED1', 'STCInprocHandler',
    'DISPID_SLWType', 'SpeechRegistryUserRoot', 'DISPID_SRGetFormat',
    'DISPID_SRCState', 'DISPID_SWFEBitsPerSample',
    'eLEXTYPE_RESERVED7', 'SPDKL_LocalMachine', 'SRSEIsSpeaking',
    'DISPID_SpeechRecoResult2', 'DISPID_SAStatus',
    'DISPID_SRGDictationSetState', 'STSF_FlagCreate',
    'SREPropertyStringChange', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SGRsItem', 'DISPID_SRGetRecognizers',
    'DISPID_SVGetAudioOutputs', 'DISPID_SLGetPronunciations',
    'DISPID_SDKEnumValues', 'SAFT32kHz8BitMono',
    'SpeechAudioFormatType', 'SPPS_RESERVED2', 'SPPS_Noun',
    'SpeechRecognizerState', 'DISPID_SPPConfidence',
    'DISPID_SRGSetWordSequenceData', 'SPINTERFERENCE_NONE',
    'DISPID_SRRPhraseInfo', 'SAFT44kHz16BitStereo', 'SPPHRASEELEMENT',
    'SVP_0', 'SREStreamEnd', 'SGDSActiveWithAutoPause',
    'DISPID_SVSkip', 'DISPID_SMSAMMHandle', 'STSF_CommonAppData',
    'SPPARTOFSPEECH', 'ISpLexicon', 'DISPID_SpeechDataKey',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SASCurrentSeekPosition', 'SREFalseRecognition',
    'eLEXTYPE_PRIVATE8', 'ISpeechXMLRecoResult',
    'DISPID_SOTCreateInstance', 'SPADAPTATIONRELEVANCE',
    'ISpeechRecoResult2', 'SpeechTokenContext', 'ISpeechCustomStream',
    'DISPID_SPPValue', 'eLEXTYPE_PRIVATE11', 'SPEI_TTS_PRIVATE',
    'DISPID_SLAddPronunciation', 'DISPID_SPIRule',
    'tagSPPROPERTYINFO', 'DISPID_SGRSTNextState', 'SpResourceManager',
    'SVP_7', 'ISpeechAudioStatus', 'SPWORDTYPE', 'DISPID_SGRSTText',
    'SpeechWordPronounceable', 'DISPID_SVEventInterests',
    'IEnumString', 'SPINTERFERENCE_NOISE', 'SPCT_SLEEP',
    'eLEXTYPE_PRIVATE7', 'SRCS_Enabled', 'SPAS_CLOSED',
    'DISPID_SpeechRecoResult', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPRulesItem', 'SpeechAudioFormatGUIDWave',
    'SPRST_INACTIVE_WITH_PURGE', 'SPWORDPRONUNCIATION',
    'ISpeechLexiconWord', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRRSetTextFeedback', 'DISPID_SOTCDefault', 'SVEAllEvents',
    'DISPID_SOTCategory', 'DISPID_SVEWord', 'SPSHORTCUTPAIRLIST',
    'ISpRecoCategory', 'SAFTDefault', 'SVEEndInputStream',
    'DISPID_SRIsUISupported', 'SpeechRuleState',
    'DISPID_SpeechGrammarRuleStateTransition', 'SBOPause',
    'SP_VISEME_8', 'SP_VISEME_2', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRAudioInputStream', 'ISpeechPhraseProperties',
    'eLEXTYPE_PRIVATE13', 'SAFTExtendedAudioFormat',
    'SAFTNonStandardFormat', 'SPDKL_CurrentUser', 'DISPID_SPEsCount',
    'eLEXTYPE_RESERVED4', 'SPPHRASE', 'DISPID_SRAudioInput',
    'DISPID_SPCIdToPhone', 'eWORDTYPE_DELETED', 'SVP_18',
    'DISPID_SpeechVoiceEvent', 'DISPID_SGRs_NewEnum',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPVISEMES', 'SpeechAddRemoveWord',
    'SPCONTEXTSTATE', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SLWsItem', 'ISpeechMemoryStream', 'SVP_16',
    'SAFT8kHz8BitMono', 'ISpGrammarBuilder', 'DISPID_SGRId', 'SPSLMA',
    'SRAONone', 'SECLowConfidence', 'SPWORDPRONOUNCEABLE', 'ISpVoice',
    'SPEVENTENUM', 'SP_VISEME_1', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SDKGetStringValue', 'DISPID_SLPPhoneIds',
    'DISPID_SpeechPhoneConverter', 'eLEXTYPE_PRIVATE10',
    'SPBINARYGRAMMAR', 'DISPID_SDKDeleteValue',
    'DISPID_SPERetainedSizeBytes', 'SP_VISEME_21', 'DISPID_SAFGuid',
    'SREAdaptation', 'SPEI_SOUND_END', 'SP_VISEME_18',
    'DISPID_SGRAttributes', 'ISpeechRecoResult', 'SPCT_COMMAND',
    'SRERequestUI', 'SPVOICESTATUS', 'ISpeechPhraseAlternates',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRCESoundStart',
    'SAFT11kHz8BitMono', 'SPRS_ACTIVE',
    'DISPID_SPANumberOfElementsInResult', 'SP_VISEME_11',
    'DISPID_SRCEEnginePrivate', 'DISPID_SLGetWords',
    'DISPID_SLWs_NewEnum', 'DISPID_SVSInputSentenceLength',
    'SpeechAudioProperties', 'SPSFunction',
    'DISPID_SRGCmdLoadFromMemory', 'SRTSMLTimeout', 'SPLOADOPTIONS',
    'IEnumSpObjectTokens',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SDKCreateKey', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SpeechAudio', 'DISPID_SOTsCount',
    'SAFTCCITT_ALaw_8kHzMono', 'SVSFIsFilename', 'SPGS_ENABLED',
    'SPFM_OPEN_READWRITE', 'SPSNotOverriden', 'SPBOOKMARKOPTIONS',
    'ISpeechLexiconPronunciations', 'SpeechVisemeType', 'SGLexical',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SPEPronunciation', 'ISpRecoContext',
    'Speech_StreamPos_Asap', 'SRERecoOtherContext', 'SRSActive',
    'DISPID_SRRecognizer', 'SBONone', 'SPEVENTSOURCEINFO',
    'DISPID_SPRsCount', 'ISpPhoneticAlphabetConverter',
    'DISPID_SPIAudioStreamPosition', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPBO_TIME_UNITS', 'SPWORD', 'ISpPhraseAlt', 'DISPID_SPPId',
    'ISpStreamFormatConverter', 'SPEI_ADAPTATION', 'SpeechLoadOption',
    'DISPID_SAVolume', 'ISpeechAudio', 'SVEWordBoundary',
    'SpStreamFormatConverter', 'DISPID_SRRSpeakAudio',
    'DISPID_SGRsAdd', 'eLEXTYPE_USER_SHORTCUT', 'SRESoundEnd',
    'ISpeechRecognizer', 'DISPID_SRCVoice', 'DISPID_SWFEExtraData',
    'SPAUDIOSTATE', 'SPBO_PAUSE', 'DISPID_SVAudioOutput',
    'DISPID_SVSRunningState', 'SPDKL_DefaultLocation',
    'DISPID_SDKSetStringValue', 'SRSEDone', 'ISpeechAudioFormat',
    'Speech_Max_Word_Length', 'SpShortcut', '__MIDL_IWinTypes_0009',
    'STCInprocServer', 'DISPID_SPRText', 'SPCATEGORYTYPE',
    'DISPID_SRSetPropertyNumber', 'SSFMCreateForWrite',
    'DISPID_SpeechPhraseElements', 'SPFM_CREATE_ALWAYS',
    'DISPID_SpeechObjectTokens', 'SPRECOSTATE', 'DISPID_SVPause',
    'SVP_21', 'SPSERIALIZEDPHRASE', 'SpTextSelectionInformation',
    'SAFT48kHz8BitStereo', 'DISPID_SOTs_NewEnum', 'SPPS_Unknown',
    'SP_VISEME_14', 'SITooLoud', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPEActualConfidence', 'SAFTGSM610_11kHzMono',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPISaveToMemory',
    'SpeechTokenKeyUI', 'DISPID_SFSOpen', 'SPEI_SR_PRIVATE',
    'SAFT24kHz8BitMono', 'STCRemoteServer',
    'DISPID_SpeechLexiconWords', 'DISPID_SPERetainedStreamOffset',
    'SPPS_Verb', 'SAFT44kHz16BitMono', 'SAFTCCITT_uLaw_11kHzStereo',
    'SAFT11kHz8BitStereo', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SVEVoiceChange', 'STSF_AppData', 'SVP_2',
    'DISPID_SPACommit', 'DISPID_SGRsCount', 'eLEXTYPE_PRIVATE20',
    'SPVPRI_OVER', 'SpeechLexiconType',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT12kHz16BitMono',
    'SINoSignal', 'DISPID_SRSClsidEngine',
    'DISPID_SVSInputWordPosition', 'SVSFUnusedFlags',
    'SVSFPurgeBeforeSpeak', 'SpeechRetainedAudioOptions',
    'ISpeechPhraseRule', 'ISpRecoContext2', 'SPAS_PAUSE', 'SRAImport',
    'ISpeechGrammarRule', 'SPVPRIORITY', 'DISPID_SADefaultFormat',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPWF_SRENGINE',
    'DISPID_SPRuleConfidence', 'SPINTERFERENCE', 'DISPID_SLPsCount',
    'DISPID_SRCEStartStream', 'SAFTADPCM_44kHzMono',
    'eLEXTYPE_PRIVATE6', 'eLEXTYPE_RESERVED8',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SGRSTPropertyName',
    'DISPID_SRGState', 'DISPID_SGRSAddSpecialTransition',
    'ISpeechGrammarRuleState',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SRCERequestUI',
    'SPEI_HYPOTHESIS', 'SPEI_VISEME', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRGRules', 'SpeechRecognitionType', 'SPWAVEFORMATTYPE',
    'DISPID_SPELexicalForm', 'SGDSActiveUserDelimited',
    'eLEXTYPE_PRIVATE12', 'SP_VISEME_4', 'SPVPRI_NORMAL',
    'DISPID_SLWLangId', 'SAFT16kHz8BitMono', 'SpInprocRecognizer',
    'SpSharedRecoContext', 'DISPID_SGRSTRule', 'SAFT22kHz16BitStereo',
    'SPSHT_OTHER', 'SDTLexicalForm', 'DISPID_SOTDisplayUI', 'SVP_11',
    'SRCS_Disabled', 'SPSUnknown', 'SPFM_CREATE', 'SAFT48kHz8BitMono',
    'DISPID_SDKGetBinaryValue', 'SPTEXTSELECTIONINFO',
    'SPEI_RESERVED6', 'SPINTERFERENCE_NOSIGNAL',
    'SpeechRecoContextState', 'SWPUnknownWordUnpronounceable',
    'SpeechPropertyComplexResponseSpeed', 'SRAInterpreter',
    'ISpObjectTokenCategory', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPPParent', 'SpeechAllElements', 'SAFTADPCM_11kHzMono',
    'SPLO_DYNAMIC', 'SSTTDictation', 'SPFILEMODE', 'SPEI_UNDEFINED',
    'SpeechCategoryAudioOut', 'SPXMLRESULTOPTIONS',
    'DISPID_SPILanguageId', 'SWTAdded', 'SRAORetainAudio',
    'Speech_Default_Weight', 'SVP_4',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpMemoryStream',
    'WAVEFORMATEX', 'DISPID_SGRsDynamic', 'SDTAlternates',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpeechRecoResultDispatch', 'eLEXTYPE_PRIVATE14',
    'DISPID_SpeechFileStream', 'SGPronounciation',
    'SAFT24kHz16BitStereo', 'SRADynamic', 'SPEI_RESERVED3',
    'DISPID_SLWsCount', 'DISPID_SRRAlternates', 'SDTRule',
    'SAFT12kHz16BitStereo', 'DISPID_SpeechLexicon',
    'SpeechPropertyResponseSpeed', 'SpeechCategoryRecoProfiles',
    'SpeechVoiceSpeakFlags', 'SVSFParseMask',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRRTLength',
    'SPWT_DISPLAY', 'SpeechFormatType', 'Speech_StreamPos_RealTime',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPRuleId',
    'DISPID_SRGReset', 'SASClosed', 'SGDisplay',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRCCreateGrammar',
    'SPRST_INACTIVE', 'SpeechTokenKeyAttributes', 'SITooFast',
    'SASStop', 'DISPID_SPRuleChildren',
    'DISPID_SOTGetStorageFileName', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPCPhoneToId',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SASNonBlockingIO',
    'SPSInterjection', 'DISPID_SpeechVoice', 'DISPID_SLPSymbolic',
    'SREPrivate', 'SECFIgnoreWidth', 'SVSFNLPSpeakPunc',
    'SPXRO_Alternates_SML', 'SAFT16kHz16BitMono',
    'DISPID_SRRGetXMLResult', 'DISPID_SpeechRecoResultTimes',
    'SP_VISEME_15', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SLOStatic', 'DISPID_SPAsCount', 'SPAR_Unknown',
    'ISpeechPhraseReplacements', 'LONG_PTR', 'SDA_One_Trailing_Space',
    'ISpRecoGrammar', 'DISPID_SABIMinNotification', 'SP_VISEME_5',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCRetainedAudio',
    'ISpRecoResult', 'eLEXTYPE_APP', 'ISpPhoneConverter',
    'SPPROPERTYINFO', 'STSF_LocalAppData', 'SPEI_RESERVED5',
    'DISPID_SVAlertBoundary', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SFSClose', 'SDA_No_Trailing_Space', 'SP_VISEME_0',
    'ISpStreamFormat', 'DISPID_SRGCommit', 'SpeechMicTraining',
    'eLEXTYPE_RESERVED10', 'DISPID_SLPLangId', 'UINT_PTR',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SpeechGrammarRules',
    'SVSFDefault', 'SAFT48kHz16BitStereo',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRRAudio',
    'DISPID_SRCEventInterests', '_ISpeechVoiceEvents', 'SVPOver',
    'eLEXTYPE_PRIVATE9', 'SPSTREAMFORMATTYPE', 'SVSFNLPMask',
    '_RemotableHandle', 'SAFTADPCM_11kHzStereo', 'SP_VISEME_13',
    'SAFTText', 'DISPID_SpeechPhraseRule', 'SGRSTTEpsilon',
    'SPVPRI_ALERT', 'DISPID_SVEAudioLevel',
    'DISPID_SREmulateRecognition', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRStatus', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRRAudioFormat', 'DISPID_SRCRecognizer',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SDKSetLongValue',
    'SpeechStreamSeekPositionType', 'SAFT32kHz16BitStereo',
    'DISPID_SVESentenceBoundary', 'SSFMCreate', 'SPPS_RESERVED4',
    'DISPID_SOTRemove', 'SVEAudioLevel', 'ISpPhrase',
    'SGRSTTWildcard', 'SPFM_OPEN_READONLY', 'SDTDisplayText',
    'DISPID_SVAudioOutputStream', 'ISpMMSysAudio',
    'DISPID_SRSCurrentStreamNumber', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPRsItem', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVEBookmark', 'SPAS_RUN',
    'DISPID_SOTGetDescription', 'DISPID_SRCESoundEnd',
    'SPEI_WORD_BOUNDARY', 'DISPID_SRCEAdaptation', 'SPRULESTATE',
    'SPEI_SR_BOOKMARK', 'SpLexicon', 'SPEVENT', 'SVEPrivate',
    'SPEI_RESERVED2', 'SPPS_LMA', 'SPEI_VOICE_CHANGE', 'SGRSTTRule',
    'SECFNoSpecialChars', 'DISPID_SGRSRule',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPIGetText',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVSLastResult',
    'DISPID_SPEs_NewEnum', 'DISPID_SOTIsUISupported',
    'DISPID_SRCEBookmark', 'SpeechRecoEvents', 'SVP_12',
    'DISPID_SGRsCommitAndSave', 'SPPS_NotOverriden',
    'DISPID_SpeechObjectToken', 'DISPID_SMSALineId', 'SVEBookmark',
    'SREBookmark', 'SITooQuiet', 'DISPID_SRGetPropertyNumber',
    'SpSharedRecognizer', 'ISpeechPhraseElement',
    'DISPID_SPAPhraseInfo', 'DISPID_SRRTStreamTime', 'SPAR_Low',
    'DISPID_SVRate', 'SPINTERFERENCE_TOOFAST', 'SECFIgnoreCase',
    'SAFTGSM610_44kHzMono', 'DISPID_SpeechPhraseElement',
    'SPAR_Medium', 'SPSHORTCUTTYPE', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPIGetDisplayAttributes',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechTokenIdUserLexicon', 'ISpRecognizer3', 'ISpNotifySource',
    'SAFT48kHz16BitMono', 'SDA_Consume_Leading_Spaces',
    'ISpeechWaveFormatEx', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechGrammarTagDictation', 'SpeechRecoProfileProperties',
    'DISPID_SVEPhoneme'
]

_check_version('1.2.0', 1638676542.771468)
